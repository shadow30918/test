      ...
      if(pageName === "" || pageName === "index"){
        ...
        $.post('func.php', {
            ...
            if (data.event.length === 1) { //有找到活動
                ...
                $('#Header .container #Menu').append('<li class="bu" data-link="https://www.facebook.com/LGTaiwan/"><span><img class="imgFullSizeH" src="../../common_img/fb.svg" /></span></li>');
                    ...
                    $.post('func.php', {
                        ...
                        $.each(objTabs, function(key, value) {
                          if(pageName === 'rule'){
                            ...
                            $('#Content .container #SubMenu li').css('cursor','context-menu');
                          }
                        ...
                        $('#Content .container #SubMenu li').on('mouseenter mouseleave click ',function(e) {
                           switch (e.type) {
                              case 'mouseenter':
                                 ...
                                 $(this).children('.sss').stop().slideDown(300);//活動辦法下拉選單
                              ...
                              case 'mouseleave':
                                 ...
                                 $(this).children('.sss').stop().slideUp(300);//活動辦法下拉選單
                                 break;
                              case 'click':
                                 $('#Content .container #SubMenu li').removeClass('select').addClass('unselect');
                                 $(this).removeClass('unselect').addClass('select');
                                 $(this).children('.sss').stop().slideUp(300);
                        ...
                        //Q+ 下拉選單
                        if( pageName === 'rule'){
                          $('#Content .container #SubMenu li:nth-child(2)').append('<div class="sss"><span class="clasic-refrigerator">一般冰箱</span><span class="slim-refrigerator">窄版冰箱</span></div>');
                          $('#Content .container #SubMenu li:nth-child(3)').append('<div class="sss"><span class="clasic-wash">一般洗衣機</span><span class="twin-wash">TwinWash雙能洗</span></div>');
                          $('#Content .container #SubMenu li:last-child').append('<div class="sss"><span>智慧電子衣櫥</span><span class="air">空氣清淨機</span><span class="dry">變頻除濕機</span></div>');
                        }
                ...
                //Menu to fire SubMenu
                $('#Header #Menu li').on('mouseenter mouseleave', function(e) {
                   if ($(this).index()===2 && e.type==='mouseenter') {
                      $('#Header .container #Menu li:nth-child(3) .subMenu').stop().fadeIn(800);
                   } else {
